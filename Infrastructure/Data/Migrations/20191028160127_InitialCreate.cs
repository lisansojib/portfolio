        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Libraries = table.Column<string>(unicode: false, maxLength: 500, nullable: true),
                    Tools = table.Column<string>(unicode: false, maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Organization = table.Column<string>(unicode: false, maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MasterId = table.Column<int>(nullable: false),
                    Caption = table.Column<string>(unicode: false, maxLength: 100, nullable: false),
                    Path = table.Column<string>(unicode: false, maxLength: 256, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectImages_Projects",
                        column: x => x.MasterId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectClients_MasterId",
                table: "ProjectClients",
                column: "MasterId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectImages_MasterId",
                table: "ProjectImages",
                column: "MasterId");
